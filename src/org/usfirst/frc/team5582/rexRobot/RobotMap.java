...
public class RobotMap {
    ...
    public static int grabberSolenoidOne = 0;
    public static int grabberSolenoidTwo = 2;
    public static int shooterSolenoidOne = 1;
    public static int shooterSolenoidTwo = 3;
